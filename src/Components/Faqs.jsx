...
const Faqss = [
  ...
  },
  {
    ...
    answer:
      "Yes, our signs are extremely weather resistant. We use ASTM I paint to ensure the light-fastness of our artwork. Additionally, a painted sign will ONLY fall off your wall if the wall itself falls down.",
  },
  {
  ...
  {
    question:
      "How long does it take to create a custom sign, mural, or ghost sign?",
    answer:
    ...
    <div className=" w-full grid lg:grid-cols-[40%_60%]">
      <div className="lg:px-0 px-3 h-full flex items-start justify-start flex-col gap-7">
        ...
        <h3 className="SuisseIntl font-[600]  lg:text-[1.4vw] lg:leading-snug">
          Still got unanswered <br /> questions? Or still wondering <br /> if a
          mural is right for you?
        </h3>
        <Button
          imgsrc={Kindman}
                ...
                {Faqss.map((faq, index) => (
                  ...
                  >
                    <div className="figee flex justify-between items-center">
                      <h3 className="SuisseIntl lg:text-[1.3vw] font-[600] text-[4.4vw] md:text-[2.1vw] text-[#222221FF] ">
                        {faq.question}
                      </h3>
                      <span className="SuisseIntl text-4xl">
                        {activeIndex === index ? "−" : "+"}
                      </span>
                    </div>
                    <div
