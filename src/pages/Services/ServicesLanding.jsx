  ...
  return (
    <div className='h-full w-full  grid lg:grid-cols-1 '>
        ...
        <Biggertext text={<>Work that's crafted to <br /> never go extinct and <br />deliver results.
            ...
            </>} classname="lg:text-[10.5vw] md:text-[10.5vw]   md:leading-20 text-[14vw] leading-13 lg:leading-31"/> 

        </div>
        <div className='h-full lg:mt-20 mt-10 grid lg:grid-cols-[1fr_1.2fr_1fr] md:grid-cols-[1fr_1.2fr_1fr] grid-cols-1 '>
  <div className='h-full lg:w-fit  '>
    <h3 className='SuisseIntl font-[400] lg:text-1xl  md:text-1xl lg:px-9 italic'>
  ...
  <div className='h-full lg:mt-0 mt-5 '>
    <div className=' w-full bg-black relative'>
      <img ref={cardsRef.current}
        ...
        className='lg:h-173 md:h-113  w-full object-cover'
        alt=""
      />
