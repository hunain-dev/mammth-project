...
const ServicesLanding = () => {
  ...
  return (
    <div className='h-full w-full  bg-red-400 grid lg:grid-cols-1 '>
        <div className='h-full w-fit text-left'>
        <Biggertext text={<>Work that's crafted to <br /> never go extinct and <br />deliver results.

            </>} classname="lg:text-[10.5vw] text-[14vw] leading-13 lg:leading-31"/> 

        </div>
        <div className='h-full lg:mt-20 mt-10 grid lg:grid-cols-[1fr_1.2fr_1fr]  '>
  <div className='h-full w-fit'>
    <h3 className='SuisseIntl font-[600] lg:text-1xl lg:px-9 italic'>
  ...
  <div className='h-full lg:mt-0 mt-5 '>
    <div className=' w-full bg-black relative'>
      <img ref={cardsRef.current}
        ...
        className='lg:h-173 w-full object-cover'
        alt=""
      />
 <div className=' absolute -top-4 -right flex items-end justify-center flex-col lg:-right-30  lg:min-w-[70%]'>
  ...
  <div className='h-full  flex items-end justify-end px-3 lg:py-21'>
    <div className=' w-full '>
    <Biggertext text={<>Every mural and sign is crafted to reflect <br /> your vision with precision and care.

</>} classname="lg:text-[2.1vw] text-4xl lg:leading-7 "/> 
