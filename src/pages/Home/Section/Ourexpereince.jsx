...
const Ourexpereince = () => {
  ...
  return (
    <div className=' w-full bg-[#47A0FF] '>
      <div className=';g:py-13 py-10 w-full  grid lg:grid-cols-[24%_76%] grid-cols-1'>
...
<div className="w-full lg:flex lg:flex-col gap-10 lg:px-11 px-3"> {/* parent with spacing */}
  {obj.map((elem, index) => (
    <div
      key={index}
      className="w-full grid lg:grid-cols-3  grid-cols-1 px-2 lg:py-0 py-5  border-t-5  border-black"
    >
      <div className="lg:h-full">
        <h2 className="ObviouslyDemo lg:text-[11vw] text-5xl lg:leading-40 font-[600]">
          {elem.number}
        </h2>
      </div>

      <div className="h-full">
        <h2 className="ObviouslyDemo lg:mt-0 mt-3 lg:text-[9.3vw] text-5xl text-[#120011] lg:leading-40 font-[600] uppercase lg:text-center">
          {elem.text}
        </h2>
      </div>

      <div className="h-full w-full lg:mt-0 mt-3 flex items-center justify-end">
        <img src={elem.img} className="lg:h-40  object-cover" alt="" />
      </div>
    </div>
  ))}
</div>
...
<div className=' w-full lg:mt-13 flex items-center justify-center  px-2 py-10 border-t-5  border-black '>
  <h2 className='ObviouslyDemo  text-[#120011] lg:text-8xl text-4xl uppercase font-[600] border-b-5 lg:border-b-8 border-black lg:py-4 py-2'>Learn About our Services</h2>
</div>
