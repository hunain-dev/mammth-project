...
const ContactLanding = () => {
  return (
    <div className=" lg:pt-23 w-full grid grid-cols-1">
    <div className="h-full w-full  ">
<Biggertext text="Get in touch" classname="lg:text-[28vw] text-8xl text-[#FFF6E5] text-center leading-64  "/> 
        
    </div>
    <div className=' m-auto  w-fit lg:mt-25 lg:pb-0 pb-20 '>
        <div className='relative'>
        <Button
          imgsrc={Kindman}
          link="https://calendly.com/mammothmurals/meeting-with-andrew-clone"
          btntext="Book A Call with us"
          classname="lg:px-9 py-3 px-5 text-1xl lg:py-5 lg:text-3xl bg-[#FFF6E5] text-black font-[600]"
        />    
...
<div className="hero_contact_top-left u-sprite u-sprite-blink is-home"></div>
    ...
    <div className="h-full w-full  ">
    <div className=" w-full   grid lg:grid-cols-3 lg:mt-7 mt-10 lg:pb-8 pb-5">
          <div className="h-full flex items-start justify-start flex-col">
            <Textanimation
              text="andrew@mammothmurals.com"
              classname="text-[#FFF6E5]  lg:eading-9 lg:text-[2vw] text-3xl"
            />
            <Textanimation
